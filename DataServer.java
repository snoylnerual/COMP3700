        ...
        while (true) {
            try {
                ...
                if (req.code == RequestModel.LOAD_PRODUCT_REQUEST) {
                    ...
                    ProductModel model = dao.loadProduct(product.productID);
                ...
                } else if (req.code == RequestModel.USER_LOGIN_REQUEST) {
                    String username = req.body.split(",")[0];
                    String password = req.body.split(",")[1];

                    LoginModel model = dao.loadUser(username, password); //dao.loadUser("adam","123456");
                ...
                } else if (req.code == RequestModel.LOAD_PRODUCT_REQUEST) {
